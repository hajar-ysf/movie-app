...
<div class="bg-stone-800">
    <div class="actor-info ">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="flex-none">
                <img src="<?php echo e($actor['profile_path']); ?>" alt="profile image" class="w-76">
                <ul class="flex items-center mt-4">

                    <?php if($social['facebook']): ?>
                        <li>
                            <a href="<?php echo e($social['facebook']); ?>" title="Facebook">
                    ...
                    <?php if($social['instagram']): ?>
                        <li class="ml-6">
                            <a href="<?php echo e($social['instagram']); ?>" title="Instagram">
                    ...
                    <?php if($social['twitter']): ?>
                        <li class="ml-6">
                            <a href="<?php echo e($social['twitter']); ?>" title="Twitter">
            ...
            <div class="md:ml-24">
                ...
                <div class="flex flex-wrap items-center text-gray-400 text-sm mt-3">
                    ...
                    <span class="ml-2"><?php echo e($actor['birthday']); ?> (<?php echo e($actor['age']); ?> years old) in <?php echo e($actor['place_of_birth']); ?></span>
                </div>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3  lg:grid-cols-5">
                    <?php $__currentLoopData = $knownForMovies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="mt-4 mx-3 sm:mx-auto md:mx-3">
            ...
            <ul class="list-disc leading-loose pl-5 mt-8">
                <?php $__currentLoopData = $credits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $credit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li>
                        ...
                        <strong><a href="<?php echo e($credit['linkToPage']); ?>" class="hover:underline"><?php echo e($credit['title']); ?></a></strong>
                         as <?php echo e($credit['character']); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\admin\movies-app\resources\views/actors/show.blade.php ENDPATH**/ ?>