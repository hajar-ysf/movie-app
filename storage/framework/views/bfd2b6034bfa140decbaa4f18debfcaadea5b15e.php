...
<div class=" movie-info px-10 grid grid-cols-1  sm:grid-cols-2">
        <div class="container flex mx-auto px-4 py-4 md:py-10 ">
                ...
                <img src="<?php echo e($tvshow['poster_path']); ?>" class="w-80  mx-auto"">
        </div>
        <div class="container mx-auto px-4 pt-5 pb-5 ">
            <h2 class="text-lg sm:text-2xl  md:text-4xl font-semibold"><?php echo e($tvshow['name']); ?></h2>
            ...
            <div class="mt-12">
                ...
                <div class="flex mt-4">
                    ...
                    <?php $__currentLoopData = $tvshow['created_by']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $crew): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="mr-8">
                            <div class="text-xs sm:text-md lg:text-lg"><?php echo e($crew['name']); ?></div>
        ...
        <div class="grid grid-cols-3  sm:grid-cols-5">
            <?php $__currentLoopData = $tvshow['cast']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cast): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="mt-8 mx-3">
                    ...
                    <div class="mt-2">
                        <a href="<?php echo e(route('actors.show', $cast['id'])); ?>" class="text-xs sm:text-md lg:text-xl mt-2 hover:text-gray:300"><?php echo e($cast['name']); ?></a>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\admin\movies-app\resources\views/tv/show.blade.php ENDPATH**/ ?>